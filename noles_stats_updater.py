...
(function() {{
  ...
  menu.querySelectorAll('a').forEach(function(a) {{
    ...
    # Write yesterday_data.js for the Previous Day's Performances page
    yesterday_js_path = BASE_DIR / "yesterday_data.js"
    yesterday_js = (
        "// Auto-generated by noles_stats_updater.py — do not edit manually\n"
        f"window.YESTERDAY_DATA = {modal_json};\n"
    )
    yesterday_js_path.write_text(yesterday_js, encoding="utf-8")
    print(f"  ✓ yesterday_data.js updated → {yesterday_js_path.name}")
